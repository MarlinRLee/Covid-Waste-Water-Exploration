...
for (i in 1:length(sites)){
  zom=AdjustedData%>%
    ...
    #geom_smooth(aes(,y=fitted),colour="red")+
    ylab("% of Covid Tests Positive")+
    ylim(minTest,maxTest)+
    scale_x_date(limits = c(StartFeces,EndFeces))
  #What the wastewater data says
    print(annotate_figure(zom,top = text_grob(sites[i], color = "red", face = "bold", size = 14)))
}

cor.test(AdjustedData$roll,AdjustedData$fitted)
