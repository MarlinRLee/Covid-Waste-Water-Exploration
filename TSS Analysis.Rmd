...
water%>%
  ggplot()+
  geom_point(aes(x=`TSS (mg/L)`,y=Pct_BCoV, size=N1))+
  scale_y_log10()+
  scale_x_log10()+
  labs(title="Madison Dorms TSS vs % BCoV Recovery")

water%>%
  ggplot()+
  geom_point(aes(x=TSS,y=Pct_BCoV, size=N1))+
  scale_y_log10()+
  labs(title="MMSD TSS vs % BCoV Recovery")
```